...
#     NVTE_FRAMEWORK=pytorch pip3 install --no-deps git+https://githubfast.com/NVIDIA/TransformerEngine.git@v2.2.1
#     pip3 install --no-deps git+https://githubfast.com/NVIDIA/Megatron-LM.git@core_v0.12.2
# fi
